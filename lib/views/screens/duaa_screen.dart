...
import 'package:wird/controllers/duaascreen_controller.dart';
import 'package:wird/data/static/Tabs.dart';
import 'package:wird/views/widgets/homepage/lastread_card.dart';

class DuaaScreen extends GetView<DuaascreenController> {
  const DuaaScreen({super.key});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => DuaascreenController());
